...
class smain {
	...
	public static String server_version = "V0.0.1";
	...
	public static void main (String[] args) throws Exception {
		try{
			...
			System.out.println("[Server] Data TelePort Server V.0.0.1.");
						...
						if(cmfg[5].equals(server_version)){
							if(cmfg[7].equals(String.valueOf(ports))){
								if(cmfg[8].equals(String.valueOf(client_ports))){
									//15
									dir_make(dir_rundir_user() + "\\DTP_DATA\\" + time_str + "\\" + cmfg[6]);
									String file_temp = dir_rundir_user() + "\\DTP_DATA\\"+ time_str + "\\" + cmfg[6] + "\\" + time_gettime() + ".dfs";
									file_make(file_temp);
